...
| `temple.png`, `magtonium.png`, `otherverse.png`, `terranium.png`, `harlemdungeon.png`, `lukelab.png`, `fiendwar.png`, `stormy.png`, `aiolite.png`, `despairore.png`, `goldenberyl.png` | zone mobs |
